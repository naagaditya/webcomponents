    ...
    <div class="calendar">
      ...
      <div class="dates">
        ${repeat(Array(this.endDateOfCalendar-this.startDateOfCalendar+1).fill(),(e,t)=>html`
          <span class$="${this.isSelectedDateIsStarts(this.startDateOfCalendar+t)?"right-bg-color":`${this.isSelectedDateIsEnds(this.startDateOfCalendar+t)?"left-bg-color":""}`}">
            <span
