      ...
      <div class="d-f ai-c">
        ...
        <span class="change-time d-f">
          <div class="d-f" on-click=${this.toggleOpenStartTimeList}>
            <span class="time-name">${this.formatedAMPMTime(this.startDate)}</span>
            <div class="down-arrow"></div>
          </div>
