    ...
    <div class="calendar">
      ...
      <div class="dates">
        ${repeat(Array(this.endDateOfCalendar-this.startDateOfCalendar+1).fill(),(e,t)=>html`
          <span
            class$="${this.getDateCellWrapperClass(this.startDateOfCalendar+t)}">
            <span
              on-click=${this.selectDate(this.startDateOfCalendar+t)}
              class$="${this.getDateCellClass(this.startDateOfCalendar+t)}">
