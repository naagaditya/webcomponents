...
var litExtended_js = require('https://unpkg.com/lit-html@0.10.2/lib/lit-extended.js');
var repeat_js = require('https://unpkg.com/lit-html@0.10.2/lib/repeat.js');
...
class ZcuiWcSearchWidget extends HTMLElement {
      ...
      <div class$="${this.pickupErrors.includes(this.selectedErrorMessage) ? 'input-box error-border' : 'input-box'}">
        <div class="input city">
          ...
          <select on-change=${this.changeCity}>
            <option>${this.cities.length ? '' : 'Please wait'}</option>
             ${repeat_js.repeat( this.cities,
              city => litExtended_js.html`
        ...
        <div class="input area">
          ...
          <div class$="${this.filteredLocation.length ? 'location-list' : 'hide'}">
            ${repeat_js.repeat(this.filteredLocation, loc => litExtended_js.html`
        ...
        <div class$="${this.startsErrors.includes(this.selectedErrorMessage) ? 'input-box error-border' : 'input-box'}">
          <div class="input date">
            ...
            <select on-change=${e => { this.changeDate(e.currentTarget.value, 'starts');}}>
              <option></option>
              ${repeat_js.repeat( Array.apply(null, {length: 31}).map((x,i)=> i+1), day => litExtended_js.html`
          ...
          <div class="input month">
            ...
            <select on-change=${e => { this.changeMonth(e.currentTarget.value, 'starts');}}>
              <option></option>
              ${repeat_js.repeat(this.monthsYears, (month, i) => litExtended_js.html`
          ...
          <div class="input time">
            ...
            <select on-change=${e => { this.changeTime(e.currentTarget.value, 'starts');}}>
              <option></option>
              ${repeat_js.repeat(this.timeList, time => litExtended_js.html `
  ...
  updateShadowDom() {
    if (this.shadowRoot) {
      litExtended_js.render(this.htmlTemplate, this.shadowRoot);
    }
  }
